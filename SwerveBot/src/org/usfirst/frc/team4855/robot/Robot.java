	...
	*/
	...
	public void autonomousInit() {
		...
		case "Forward Switch":
			...
			setAutoQueue(0.5,PREPARE_DRIVESTRAIGHT,DIR_FORWARD);
			setAutoQueue(1.5,DRIVE_STRAIGHT,75); //original: 90
			...
			setActuateQueue(5,OPEN_ARM);//open arm to take 2nd cube here
			setActuateQueue(0.5,CLOSE_ARM);
		...
		case "Strafe Left Switch":
			...
			setAutoQueue(0.5,PREPARE_DRIVESTRAIGHT,DIR_RIGHT);
			setAutoQueue(3.5,DRIVE_STRAIGHT,170,DIR_RIGHT); // previously 140
			setAutoQueue(0.5,PREPARE_DRIVESTRAIGHT,DIR_FORWARD);
			...
			setAutoQueue(1,PREPARE_DRIVESTRAIGHT,DIR_LEFT);
			setAutoQueue(2,DRIVE_STRAIGHT,80,DIR_LEFT); // previously 65
			//setAutoQueue(1,PREPARE_DRIVESTRAIGHT,DIR_FORWARD);
	...
	public void teleopPeriodic() {
		...
		if (joystick2.getRawAxis(1) >= -.2 && joystick2.getRawAxis(1) <= .2) {
			liftLock = false;
		}
		SmartDashboard.putBoolean("liftLock", liftLock);*/
